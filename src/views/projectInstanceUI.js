            ...
            <div>
                ...
                >
                    <form className="react-Modal">
                        <div className="add-project-modal-header">
                            CHANGE PROJECT
                            <span onClick={this.handleCloseModalChangeProject}>
                                {' '}
                                X
                            </span>
                        </div>
                ...
                >
                    ...
                    >
                        <div className="add-project-modal-header">
                            DELETE INSTANCE
                            <span onClick={this.handleCloseModalDeleteInstance}>
                                {' '}
                                X
                            </span>
                        </div>
                        ...
                        <div className="add-project-form-wrapper">
                            <div className="delete-Info">
                                <img
                                    src={require('../img/deleteProjects.png')}
                                    alt="delete"
                                />
                                <span>
                                    INSTANCE NAME:{' '}
                ...
                <div className="dashboard-wrapper">
                    ...
                    <div>
                        {' '}
                        {this.displayProjectInstances(
                            this.props.projectInstance
                        )}
                    </div>
                    <TablePagination
                        component="div"
